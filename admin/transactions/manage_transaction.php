            ...
            <div class="card-body">
                <div class="container-fluid">
                    <form action="" id="transaction-form">
                                ...
                                <fieldset>
                                    ...
                                    <table class="table table-striped table-bordered" id="service-list">
                                        ...
                                        <tbody>
                                            ...
                                            $service_amount = 0;
                                            if(isset($id)):
                                            $ts_qry = $conn->query("SELECT ts.*, s.name as `service` 
                                                                    FROM `transaction_services` ts inner join `service_list` s on ts.service_id = s.id 
                                ...
                                <fieldset>
                                    ...
                                    <table class="table table-striped table-bordered" id="product-list">
                                        ...
                                        <?php 
                                            $product_total = 0;
                                            if(isset($id)):
                                            $tp_qry = $conn->query("SELECT tp.*, p.name as `product` 
                                                                    FROM `transaction_products` tp inner join `product_list` p on tp.product_id = p.id 
                        ...
                        <hr>
                        <?php if($_settings->userdata('type') == 2 && !isset($id)): ?>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <select name="tech_id" id="tech_id" class="form-control form-control rounded-0">
                                        ...
                                        <?php 
                                        $tech_qry = $conn->query("SELECT *,concat(firstname,' ', lastname) as `name` FROM `users` where `type` = 2 order by `name` asc");
