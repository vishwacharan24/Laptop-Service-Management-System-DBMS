...
<div class="content py-3">
    <div class="card card-outline card-navy rounded-0 shadow">
        ...
        <div class="card-body">
            <div class="container-fluid" id="printout">
                <div class="row mb-0">
                    <div class="col-3 py-1 px-2 border border-navy bg-gradient-navy mb-0"><b>Invoice Number</b></div>
    ...
    <?php if ($_settings->userdata('type') == 1): // Check if the user is an Administrator ?>
    ...
    <?php elseif ($_settings->userdata('type') == 2): // Check if the user is a Technician ?>
